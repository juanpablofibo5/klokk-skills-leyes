...
Para cada hallazgo sobre el código auditado:
  ...
  ¿El código corrompe la clasificación de turno o los límites base de jornada?
  (RD-01, RD-02, RD-03)
     SÍ  -> CRÍTICO  (todos los cálculos posteriores quedan mal)
     NO  -> siguiente pregunta

  ¿El código produce horas mal contadas o deja excesos sin detectar?
  (RD-04, RD-05, RD-07)
     SÍ  -> ALTO  (el registro existe pero miente sobre la jornada real)
     NO  -> siguiente pregunta

  ¿El código tiene representación incompleta de distribuciones pactadas
  o falta la alerta de protección salarial? (RD-06, RD-08, RD-09)
     SÍ  -> MEDIO
